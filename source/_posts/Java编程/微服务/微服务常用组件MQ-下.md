...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/VohQbYwSlo8R6AxfinGcLNq6nld.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/VtLLb0dSFo6XOdx1EEiczVvbnvc.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/E2IcbQ9bQoCDTVx8m8GciifXnKe.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/TR81bF8E3ocm72xkaqHcuN9Nnph.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/YmF2bo8C8ot7CexZXopcsIyTnYc.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/NPr8bcUqkoNVgIxP7ePct6thn4g.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/CxrxbP3awotxmkxSndlcE7iKnvd.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/UoozbQ7W4oabs2xlaDjcTwWZnLf.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/D7mmbzVySoa0VzxTQ6Ucbpl2nKb.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/EBkmbWPYIo1x2KxnEXUcWHcHn0U.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/AFUlbn4sMoqeX6xbldFcQPbYnXc.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/MaLabMxNNoh4gMxwHDxc4MxTnoh.png)

放行以后，由于抛出的是**消息转换异常**，因此 Spring 会自动返回 `reject`，所以消息依然会被删除：

![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/OuJLbuT9eowqpaxI7TNcimyinZc.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/UkKwbmXVpoyeUyxxxxncpY5NnMg.png)

放行以后，由于抛出的是业务异常，所以 Spring 返回 `ack`，最终消息恢复至 `Ready` 状态，并且没有被 RabbitMQ 删除：

![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/K8qRb41Uso5Riyx95aLcGAYQnCe.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/B2SpbJ5Rxo78AQxuyXQcauXsn4b.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/DU6Bbv9ELogXMVxjEYZcS4C4nae.png)

假如我们现在发送一条消息到 `ttl.fanout`，RoutingKey 为 blue，并设置消息的**有效期**为 5000 毫秒：

![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/IGCWbzpEKo3loaxCJWkcQukZnme.png)

消息肯定会被投递到 `ttl.queue` 之后，由于没有消费者，因此消息无人消费。5 秒之后，消息的有效期到期，成为死信：

![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/JLSsbX5RyoZCKTxCxhGcksRynFb.png)

死信被再次投递到死信交换机 `hmall.direct`，并沿用之前的 RoutingKey，也就是 `blue`：

![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/RVgSbj8otoQtKYxsd4jc2OdFnOb.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/KZx0bBSh7ofh4jxA0lTcTlL1nic.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/KqSKbHiB5oHaCPxSVG5cBt00nac.png)

当然，也可以直接使用课前资料提供好的插件：

![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/U7x4bEQwcosUk2xNHdGc098znec.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/TZdFbdnG8oJ9aSxedA9cjII6n0f.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/GHBGbT2WLoreOwxwyT5cPu1anOf.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/W4Vgbbic5oNMEBxXa3sc3sxFnVc.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/U4aPbhArAovCXyxs3iRcH6IUnAc.png)
...
![](http://fastly.jsdelivr.net/gh/lowols/Pictures@main/posts/微服务常用组件MQ-下_Img/PJhBb1EiOoIfjRxJTEQchVcinvb.png)
